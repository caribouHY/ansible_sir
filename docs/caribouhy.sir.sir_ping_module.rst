.. _caribouhy.sir.sir_ping_module:
...
**Tests reachability using ping from Si-R router.**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Define echo type ip or ipv6 when dest is hostname.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The IP Address or hostname (resolvable by router) of the remote node.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Specify timeout interval.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;ping 198.51.100.251 source 192.168.10.1 repeat 20&#x27;]</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
